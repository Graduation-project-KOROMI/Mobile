...
type HistoryScreenViewProps = {
  ...
  onOpenResult: (entry: PredictionHistoryEntry) => void;
};

export function HistoryScreenView({ sx, sy, entries, onOpenResult }: HistoryScreenViewProps) {
  return (
    <AppScreenBackground
